...
fn run() -> Result<(), String> {
    ...
    let timings_json = |profiled: &burn_trellis::pipeline::TrellisInferenceProfile| {
        json!({
            ...
            "decode_model_load": profiled.timings.decode_model_load_ms,
            "decode_shape_decoder": profiled.timings.decode_shape_decoder_ms,
            "decode_tex_decoder": profiled.timings.decode_tex_decoder_ms,
            "decode_output_materialize": profiled.timings.decode_output_materialize_ms,
            "decode_attr_merge": profiled.timings.decode_attr_merge_ms,
            "decode_mesh": profiled.timings.decode_mesh_ms,
            "decode_remesh_bvh": profiled.timings.decode_remesh_bvh_ms,
            "decode_remesh_refine": profiled.timings.decode_remesh_refine_ms,
            "decode_remesh_dc": profiled.timings.decode_remesh_dc_ms,
            "decode_remesh_cleanup": profiled.timings.decode_remesh_cleanup_ms,
            "decode_remesh_total": profiled.timings.decode_remesh_total_ms,
