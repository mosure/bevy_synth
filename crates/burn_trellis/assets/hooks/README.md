...
To run strict e2e parity validation:

```powershell
$env:TRELLIS2_E2E_STRICT = "1"
$env:TRELLIS2_E2E_DEVICE = "cpu"
cargo test -p burn_trellis --features runtime-model trellis2_e2e_hook_alignment_against_reference -- --nocapture
```
