...
pub struct PbrBakeDebug {
    ...
    pub raster_candidate_texels: usize,
    pub raster_conflict_texels: usize,
    pub zero_support_samples: usize,
    pub projection_rejected_samples: usize,
    pub inpainted_texels: usize,
