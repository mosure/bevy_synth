...
pub use pipeline::{
    SceneAiProvider, SceneBsnRequest, ScenePipeline, SceneQualityRubricIssue,
    SceneQualityRubricRequest, SceneQualityRubricResponse, SceneReasoningRequest,
    SceneRotationSelection, SceneRotationSelectionRequest, SceneRotationSelectionResponse,
