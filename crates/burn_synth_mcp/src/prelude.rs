...
pub(crate) use burn_synth_scene::{
    ...
    SceneAssetSymmetry, SceneBsnRequest, SceneBuildConfig, SceneCategoryFilterConfig,
    SceneDecisionLog, SceneDecisionLogEntry, SceneFinalYawRefinementConfig,
    SceneFinalYawRefinementMode, SceneGroundCalibrationReport, SceneGroundingEvidence,
    SceneObjectCategory, SceneObjectManifest, SceneObjectPoseRefinementConfig,
    SceneObjectPoseRefinementMode, SceneObjectPoseRefinementSet, ScenePipeline,
    ScenePipelineTomlConfig, ScenePlan, ScenePoseFitMode, ScenePoseFitObjectFilter,
    SceneQualityProfile, SceneQualityRubricRequest, SceneQualityRubricResponse,
    SceneReasoningRequest, SceneResult, SceneRotationFitConfig, SceneRotationFitMode,
    SceneRotationFitOutcome, SceneRotationSelectionRequest, SceneRotationSelectionResponse,
    SceneScalePolicy, SceneVisibleSurfacePoseFitConfig, apply_chair_type_groups,
    apply_ground_calibration_response, apply_scene_category_filter,
    ...
    grounded_scene_layout_with_evidence_config, load_scene_pipeline_toml,
    manifest_grounding_evidence, manifest_with_grounding_evidence, parse_scene_bsn,
    parse_scene_category, scene_asset_declaration_for_bsn, scene_pipeline_toml_template,
