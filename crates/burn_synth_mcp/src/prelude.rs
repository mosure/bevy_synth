...
pub(crate) use burn_synth_scene::{
    ...
    SceneObjectManifest, ScenePipeline, ScenePlan, SceneQualityProfile, SceneReasoningRequest,
    SceneResult, SceneRotationSelectionRequest, SceneRotationSelectionResponse, SceneScalePolicy,
    canonical_pose_evidence_for_assets, grounded_scene_layout, grounded_scene_layout_for_manifest,
