...
pub(crate) use burn_synth_scene::{
    ...
    SceneGroundCalibrationReport, SceneGroundingEvidence, SceneObjectManifest,
    SceneObjectPoseRefinementConfig, SceneObjectPoseRefinementMode, SceneObjectPoseRefinementSet,
    ScenePipeline, ScenePlan, ScenePoseFitMode, ScenePoseFitObjectFilter, SceneQualityProfile,
    SceneQualityRubricRequest, SceneQualityRubricResponse, SceneReasoningRequest, SceneResult,
    SceneRotationFitConfig, SceneRotationFitMode, SceneRotationSelectionRequest,
    SceneRotationSelectionResponse, SceneScalePolicy, SceneVisibleSurfacePoseFitConfig,
    apply_chair_type_groups, apply_ground_calibration_response, apply_scene_object_pose_refinement,
    apply_scene_rotation_fit, apply_scene_visible_surface_pose_fit,
    canonical_pose_evidence_for_assets, chair_type_grouping_report, grounded_scene_layout,
    grounded_scene_layout_for_manifest, grounded_scene_layout_with_evidence_config,
    manifest_grounding_evidence, manifest_with_grounding_evidence, parse_scene_bsn,
    scene_asset_declaration_for_bsn, scene_plan_to_mcp_commands,
    select_object_image_candidates_with_exclusions, symmetry_for_descriptor, write_json_file,
    write_visible_surface_fit_artifacts,
};
