...
def main() -> None:
    parser = argparse.ArgumentParser(description="Export TripoSG pipeline reference tensors")
    parser.add_argument("--weights", default=None)
    parser.add_argument(
        "--inputs",
        default=str(PROJECT_DIR / "assets/hooks/triposg_pipeline_input.safetensors"),
    )
    parser.add_argument(
        "--output",
        default=str(PROJECT_DIR / "assets/hooks/triposg_pipeline_reference.safetensors"),
    )
