...
const MSE: f32 = 0.1;
const GRID_MAX_ABS: f32 = 10.0;
const GRID_MEAN_ABS: f32 = 0.4;
const GRID_MSE: f32 = 1.0;
const PREP_MAX_ABS: f32 = 200.0;
const PREP_MEAN_ABS: f32 = 1.0;
const PREP_MSE: f32 = 30.0;
...
fn resolve_weights_root() -> std::path::PathBuf {
    ...
    let path = std::path::PathBuf::from(TRIPOSG_ROOT);
    if path.exists() {
        return path;
    }
