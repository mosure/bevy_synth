...
impl MidiConfig {
    pub fn init<B: Backend>(&self, device: &B::Device) -> Midi<B> {
        Midi::new(device, self.clone())
    }
...
#[derive(Debug, Clone)]
pub struct MidiOutput<B: Backend> {
